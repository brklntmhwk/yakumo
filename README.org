...
|---------+------------+--------------------------------------------------------+--------------------+------------------------------------+--------------|
| Desktop | tsutsuyami | Self-built Mini-ITX PC with AMD Ryzen 5 7600X and more | NixOS              | Main development workstation.      | Ohma Togaki  |
...
- *The theming approach and the fewer ~with~ as possible policy:* [[https://github.com/sioodmy/dotfiles][Sioodmy's Dotfiles]]
