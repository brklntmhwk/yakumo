# Based on:
# https://github.com/NixOS/nixpkgs/blob/ed142ab1b3a092c4d149245d0c4126a5d7ea00b0/pkgs/by-name/fc/fcitx5-mozc/package.nix
{
  bazel_7,
  buildBazelPackage,
  fcitx5,
...
buildBazelPackage {
  pname = "fcitx5-mozc-with-emacs-helper"; # Differentiate this from the original.
  ...
  bazelTargets = [
    ...
    "unix/icons"
    "unix/emacs:mozc_emacs_helper" # Add mozc_emacs_helper support.
  ];
