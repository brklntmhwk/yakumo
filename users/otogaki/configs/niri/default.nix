...
let inherit (theme) colors fonts cursorThemes;
in {
  ...
  input = {
    ...
    trackpoint.scroll-method = { _args = [ "on-button-down" ]; };
    trackball.scroll-method = { _args = [ "on-button-down" ]; };
  ...
  output = [
    {
      _args = [ "DP-2" ];
      mode = { _args = [ "3840x2160" ]; };
      scale = { _args = [ 2 ]; };
      transform = { _args = [ "normal" ]; };
      position = {
        _props = {
          x = 0;
          y = 0;
  ...
  layout = {
    gaps = { _args = [ 16 ]; };
    center-focused-column = { _args = [ "never" ]; };
    ...
    focus-ring = {
      width = { _args = [ 4 ]; };
      active-color = { _args = [ colors.blue-faint ]; };
      inactive-color = { _args = [ colors.fg-dim ]; };
    };
    border = {
      off = { };
      width = { _args = [ 4 ]; };
      active-color = { _args = [ colors.yellow-faint ]; };
      inactive-color = { _args = [ colors.fg-dim ]; };
      urgent-color = { _args = [ colors.red ]; };
    };
    shadow = {
      softness = { _args = [ 30 ]; };
      spread = { _args = [ 5 ]; };
  ...
  # Screenshots
  screenshot-path = { _args = [ "~/Pictures/Screenshots/%Y%m%d%H%M%S.png" ]; };

  # https://yalter.github.io/niri/Configuration:-Animations
  animations = {
    workspace-switch.curve = { _args = [ "cubic-bezier" 0.22 1.0 0.36 1.0 ]; };
    window-open = {
      duration-ms = { _args = [ 150 ]; };
      curve = { _args = [ "ease-out-expo" ]; };
    };
    window-close.curve = { _args = [ "cubic-bezier" 0.87 0.0 0.13 1.0 ]; };
  ...
  binds = {
    ...
    "XF86AudioRaiseVolume" = {
      _props.allow-when-locked = true;
      spawn-sh = { _args = [ "wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+" ]; };
    };
    ...
    "XF86MonBrightnessUp" = {
      _props.allow-when-locked = true;
      spawn = { _args = [ "brightnessctl" "--class=backlight" "set" "+5%" ]; };
    };
    ...
    "Mod+Shift+Ctrl+B" = { move-column-to-monitor-left = { }; };
    "Mod+Shift+Ctrl+N" = { move-column-to-monitor-down = { }; };
    "Mod+Shift+Ctrl+P" = { move-column-to-monitor-up = { }; };
    "Mod+Shift+Ctrl+F" = { move-column-to-monitor-right = { }; };
