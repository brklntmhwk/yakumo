    ...
    servers = mkOption {
      type = types.attrsOf (types.submodule {
        ...
        options = {
          ...
          args = mkOption {
            type =
              types.listOf (types.oneOf [ types.bool types.int types.str ]);
            default = [ ];
          };
          env = mkOption {
            type =
              types.attrsOf (types.oneOf [ types.bool types.int types.str ]);
            default = { };
          };
          url = mkOption {
