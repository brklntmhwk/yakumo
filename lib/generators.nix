  ...
  toSwayidleConf =
    ...
    let
      timeoutStr =
        ...
        + (optionalString (t.resumeCommand != null) " resume '${t.resumeCommand}'");
  ...
  toKDL =
    ...
    let
      ...
      convertAttrsToKDL =
        ...
        in
        concatStringsSep " " ([ name ] ++ optArgs ++ optProps ++ optChildren) + terminator;
